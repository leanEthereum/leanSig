    ...
    pub mod target_sum {
        ...
        mod test {
            ...
            pub fn test_w1_correctness() {
                ...
                _test_signature_scheme_correctness::<SIGTargetSumLifetime20W1Off10>(
                    321,
                    0,
                    1 << 20,
                );
            ...
            #[cfg(feature = "slow-tests")]
            pub fn test_w2_correctness() {
                _test_signature_scheme_correctness::<SIGTargetSumLifetime20W2NoOff>(54, 0, 1 << 20);
            ...
            #[cfg(feature = "slow-tests")]
            pub fn test_w4_correctness() {
                _test_signature_scheme_correctness::<SIGTargetSumLifetime20W4NoOff>(
                    3435,
                    0,
                    1 << 20,
                );
            ...
            #[cfg(feature = "slow-tests")]
            pub fn test_w8_correctness() {
                _test_signature_scheme_correctness::<SIGTargetSumLifetime20W8NoOff>(
                    3241,
                    0,
                    1 << 20,
                );
                _test_signature_scheme_correctness::<SIGTargetSumLifetime20W8Off10>(34, 0, 1 << 20);
            }
        }
    }
}
